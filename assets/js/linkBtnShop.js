function whatsapp(){
 ...
 let type = document.getElementById("title").textContent
...
var text = 'Olá,%20estou%20no%20site,%20e%20quero%20Elo%20Job.%20Estou%20no%20'+lga+'%20'+dva.options[dva.selectedIndex].text+'%20e%20quero%20chegar%20no%20'+lgd+'%20'+dvd.options[dvd.selectedIndex].text+',  '+value+"."
console.log(text)
